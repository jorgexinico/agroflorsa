...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mostrar/ocultar fecha de vencimiento al cambiar producto
...
// ── Actualizar visibilidad de fecha vencimiento ──────────
function actualizarFechaVenc(select) {
    ...
    if (!celda) return;
    if (manejaVenc) {
        celda.innerHTML = `<input type="date" name="fecha_vencimiento[]" class="form-control form-control-sm">`;
    } else {
